...
function FeatureIcon({ type }: { type: "workout" | "food" | "photo" | "ai" }) {
  switch (type) {
    case "workout":
      return (
        <svg className="h-8 w-8 text-rust" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="space-y-6">
        {/* Top Stats Bar */}
        <JournalCard title="Daily Summary">
          <DashboardStats
            userId={user.id}
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          {/* Workout Card */}
          <Link href="/journal" className="group h-full">
            <JournalCard className="h-full transition-all group-hover:border-rust/50 group-hover:shadow-md">
              <div className="flex items-start justify-between mb-4">
                <div className="rounded-full bg-rust/10 p-3 text-rust">
                  <FeatureIcon type="workout" />
                </div>
                <span className="text-xs font-bold uppercase tracking-wider text-ink/40 group-hover:text-rust">
                  Journal
                </span>
              </div>
              <h3 className="font-heading text-xl font-bold text-ink mb-2">Log Workout</h3>
              <p className="text-sm text-ink/70 mb-4">
                Record today&apos;s exercises, sets, and reps.
              </p>
              <span className="text-sm font-bold text-rust group-hover:underline">
                Open Journal &rarr;
              </span>
            </JournalCard>
          </Link>
          ...
          {/* Nutrition Card */}
          <Link href="/nutrition" className="group h-full">
            <JournalCard className="h-full transition-all group-hover:border-rust/50 group-hover:shadow-md">
              <div className="flex items-start justify-between mb-4">
                <div className="rounded-full bg-rust/10 p-3 text-rust">
                  <FeatureIcon type="food" />
              ...
              <h3 className="font-heading text-xl font-bold text-ink mb-2">Log Meals</h3>
              <p className="text-sm text-ink/70 mb-4">
          ...
          {/* Photos Card */}
          <Link href="/photos" className="group h-full">
            <JournalCard className="h-full transition-all group-hover:border-rust/50 group-hover:shadow-md">
              <div className="flex items-start justify-between mb-4">
                <div className="rounded-full bg-rust/10 p-3 text-rust">
                  <FeatureIcon type="photo" />
              ...
              <h3 className="font-heading text-xl font-bold text-ink mb-2">Daily Photo</h3>
              <p className="text-sm text-ink/70 mb-4">
          ...
          {/* Profile Card */}
          <Link href="/profile" className="group h-full">
            <JournalCard className="h-full transition-all group-hover:border-rust/50 group-hover:shadow-md">
              <div className="flex items-start justify-between mb-4">
                <div className="rounded-full bg-rust/10 p-3 text-rust">
              ...
              <h3 className="font-heading text-xl font-bold text-ink mb-2">My Profile</h3>
              <p className="text-sm text-ink/70 mb-4">
